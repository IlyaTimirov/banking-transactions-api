Есть docker-compose файл для базы данных Postgres. Можно запустить его или подключить свою. 
...
Есть служебный апи (с открытым доступом), через который можно заводить новых пользователей в системе, указав логин, пароль, изначальную сумму, телефон и email (логин, телефон и email не должны быть заняты).
...
Сделано АПИ поиска. Искать можно любого клиента. Есть фильтрация и пагинация/сортировка. Фильтры:
